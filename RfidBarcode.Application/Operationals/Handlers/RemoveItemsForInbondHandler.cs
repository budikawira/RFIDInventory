...
{
    public class RemoveItemsForInbondHandler : BaseHandler, IRequestHandler<RemoveItemsForInbondRequest, BaseResponse>
    {
        public RemoveItemsForInbondHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<BaseResponse> Handle(RemoveItemsForInbondRequest request, CancellationToken cancellationToken)
        {
