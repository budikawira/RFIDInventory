            ...
            try
            {
                ...
                else
                {
                    ...
                    if (entity != null)
                    {
                        ...
                        entity.InSuratJalanId = request.Data.InSuratJalanId;
                        entity.OutSuratJalanId = request.Data.OutSuratJalanId;
                        ...
                        entity.InSuratJalanId = request.Data.InSuratJalanId;
                        entity.InScanUserId = request.Data.InScanUserId;
                        entity.InScan = request.Data.InScan;
                        entity.Epc = Helper.GetEpc(entity.Id);
                        entity.Qr = Helper.GetQr(entity);
