    ...
    public partial class _001_Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuratJalanTypes", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Grade = table.Column<string>(type: "longtext", nullable: true),
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    FinalizeDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuratJalans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuratJalans_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalLocationName = table.Column<string>(type: "longtext", nullable: true),
                    TrolleyId = table.Column<long>(type: "bigint", nullable: true),
                    FinalTrolleyName = table.Column<string>(type: "longtext", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockOpnames_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockOpnames_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentitasBenang = table.Column<string>(type: "longtext", nullable: true),
                    ...
                    InSuratJalanId = table.Column<long>(type: "bigint", nullable: true),
                    InScanUserId = table.Column<long>(type: "bigint", nullable: true),
                    InScanUser = table.Column<string>(type: "longtext", nullable: true),
                    InScan = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    OutSuratJalanId = table.Column<long>(type: "bigint", nullable: true),
                    OutScanUserId = table.Column<long>(type: "bigint", nullable: true),
                    OutScanUser = table.Column<string>(type: "longtext", nullable: true),
                    OutScan = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_SuratJalans_InSuratJalanId",
                        column: x => x.InSuratJalanId,
                        principalTable: "SuratJalans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Items_SuratJalans_OutSuratJalanId",
                        column: x => x.OutSuratJalanId,
                        principalTable: "SuratJalans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Items_SuratJalans_SuratJalanId",
                        column: x => x.SuratJalanId,
                        principalTable: "SuratJalans",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalLocation = table.Column<string>(type: "longtext", nullable: true),
                    Note = table.Column<string>(type: "longtext", nullable: true),
                    Source = table.Column<string>(type: "longtext", nullable: true),
                    PrevLocationId = table.Column<long>(type: "bigint", nullable: true),
                    StockOpnameId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: false),
                    LastUpdateDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastUpdateBy = table.Column<string>(type: "longtext", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TagLocations_Locations_PrevLocationId",
                        column: x => x.PrevLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TagLocations_StockOpnames_StockOpnameId",
            ...
            migrationBuilder.CreateTable(
                name: "StockOpnameDetails",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    StockOpnameId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockOpnameDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockOpnameDetails_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockOpnameDetails_StockOpnames_StockOpnameId",
                        column: x => x.StockOpnameId,
                        principalTable: "StockOpnames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockOpnameDetails_TagLocations_TagLocationId",
                        column: x => x.TagLocationId,
                        principalTable: "TagLocations",
                        principalColumn: "Id");
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "UM", "system", new DateTime(2025, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "User Management", "system", new DateTime(2025, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "UM", "system", new DateTime(2025, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "system", new DateTime(2025, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 1L });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_InSuratJalanId",
                table: "Items",
                column: "InSuratJalanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_OutSuratJalanId",
                table: "Items",
                column: "OutSuratJalanId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_SuratJalanId",
                table: "Items",
                column: "SuratJalanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockOpnameDetails_ItemId",
                table: "StockOpnameDetails",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOpnameDetails_StockOpnameId",
                table: "StockOpnameDetails",
                column: "StockOpnameId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOpnameDetails_TagLocationId",
                table: "StockOpnameDetails",
                column: "TagLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOpnames_LocationId",
                table: "StockOpnames",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_StockOpnames_UserId",
                table: "StockOpnames",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SuratJalans_UserId",
                table: "SuratJalans",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SuratJalanTypes_Name",
                table: "SuratJalanTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SuratJalanTypes_Type",
                table: "SuratJalanTypes",
                column: "Type");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagLocations_PrevLocationId",
                table: "TagLocations",
                column: "PrevLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TagLocations_StockOpnameId",
                table: "TagLocations",
                column: "StockOpnameId");
        }
